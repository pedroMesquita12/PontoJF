...
var WhatsappService = function () {
    ...
    var WhatsappService = _classThis = /** @class */ (function () {
        ...
        WhatsappService_1.prototype.enviarMensagemRegistroPonto = function (params) {
            return __awaiter(this, void 0, void 0, function () {
                var token, phoneNumberId, to, url, response, data;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            url = "https://graph.facebook.com/v23.0/".concat(phoneNumberId, "/messages");
