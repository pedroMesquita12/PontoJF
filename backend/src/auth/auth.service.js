...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.login = function (matricula, senha) {
            return __awaiter(this, void 0, void 0, function () {
                var funcionario, senhaValida, error_1;
                var _a, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            _c.trys.push([0, 4, , 5]);
                            console.log('LOGIN RECEBIDO:', { matricula: matricula, senha: senha });
                        ...
                        case 1:
                            ...
                            if (!funcionario || !funcionario.usuarios) {
                                throw new common_1.UnauthorizedException('Matrícula ou senha inválida');
                            }
                            if (!funcionario.usuarios.ativo) {
                                throw new common_1.UnauthorizedException('Usuário inativo');
                            }
                            return [4 /*yield*/, bcrypt.compare(senha, funcionario.usuarios.senha_hash)];
                        case 2:
                            senhaValida = _c.sent();
                        ...
                        case 3:
                            ...
                            return [2 /*return*/, {
                                    user: {
                                        ...
                                        cargo: (_b = (_a = funcionario.cargos) === null || _a === void 0 ? void 0 : _a.nome) !== null && _b !== void 0 ? _b : 'Funcionário',
                                        perfil: funcionario.usuarios.perfil,
                                    },
                                }];
                        case 4:
                            error_1 = _c.sent();
                            console.error('ERRO NO AUTH SERVICE:', error_1);
                            throw error_1;
